...
namespace TitanTracker.Data.Migrations
{
    ...
    [Migration("20210919060902_NotificationModelDraftAdded")]
    partial class NotificationModelDraftAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TitanTracker.Models.Invite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TitanTracker.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TitanTracker.Models.ProjectPriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TitanTracker.Models.TicketComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TitanTracker.Models.TicketHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TitanTracker.Models.TicketPriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TitanTracker.Models.TicketStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TitanTracker.Models.Invite", b =>
                {
                    ...
                    b.HasOne("TitanTracker.Models.BTUser", "Invitee")
                        .WithMany()
                        .HasForeignKey("InviteeId");

                    b.HasOne("TitanTracker.Models.BTUser", "Invitor")
                        .WithMany()
            ...
            modelBuilder.Entity("TitanTracker.Models.Notification", b =>
                {
                    ...
                    b.HasOne("TitanTracker.Models.BTUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TitanTracker.Models.BTUser", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TitanTracker.Models.Ticket", "Ticket")
            ...
            modelBuilder.Entity("TitanTracker.Models.Ticket", b =>
                {
                    b.HasOne("TitanTracker.Models.BTUser", "DeveloperUser")
                        .WithMany()
                        .HasForeignKey("DeveloperUserId");

                    b.HasOne("TitanTracker.Models.BTUser", "OwnerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TitanTracker.Models.TicketAttachment", b =>
                {
                    ...
                    b.HasOne("TitanTracker.Models.BTUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
